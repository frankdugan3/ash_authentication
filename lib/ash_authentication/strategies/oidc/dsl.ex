defmodule AshAuthentication.Strategy.OIDC.Dsl do
  ...
  defp patch_schema do
    ...
    |> Keyword.merge(
      ...
      nonce: [
        type: {:or, [{:in, [true]}, AshAuthentication.Dsl.secret_type()]},
        doc: """
        A function for generating the session nonce, or `true`.

        When set to `true` the nonce will be automatically generated.
